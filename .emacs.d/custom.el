(custom-set-variables
 ...
 '(package-selected-packages
   '(emacs-everywhere jabber aggressive-indent perspective vhdl-ext
		      altcaps consult-notmuch consult-org-roam
		      consult-projectile treemacs-icons-dired
		      spanish-holidays olivetti org-roam-ui flycheck
		      auto-complete yasnippet embark-consult embark
		      consult orderless projectile pdf-tools lin
		      vertico telega gptel nov multiple-cursors
		      helm-core magit-section visual-fill-column
		      elfeed-tube-mpv elfeed-tube org-alert tzc
		      notmuch-indicator gnuplot gnuplot-mode
		      ...
		      smart-mode-line popper org-books marginalia
		      crossword gif-screencast helm-notmuch
		      helm-org-rifle rainbow-mode decide engine-mode
		      org-pomodoro modus-themes exec-path-from-shell
		      dashboard org-roam zenburn-theme hledger-mode
		      scratch sudoku notmuch ebdb dictionary emojify
		      org-bullets company which-key helm htmlize magit
		      emms elfeed 2048-game))
